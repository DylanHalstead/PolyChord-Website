    ...
    <div id="employees-container">
        ...
        <div class="employee">
            ...
            <div class="employee__info-container">
                ...
                <p class="employee__text">
                    Professor Lasenby is our leading expert in Bayesian science and geometric algebra. He assists in the development of 
                    the company's core technologies. Professor Lasenby is also an Emeritus Cambridge Professor of Astrophysics and 
                    Cosmology and a Fellow of Queens College. 
                </p>
            </div>
        </div>
        <div class="employee">
        ...
        <div class="employee">
            ...
            <div class="employee__info-container">
                ...
                <p class="employee__title">Data Scientist</p>
                <p class="employee__text">
                    A computational physicist with a passion for bio-inspired design and self-assembly, Dr.Formanek is currently working 
                    on PolyChord Ltd's protein folding initiative, specialising it to predict protein-protein binding affinities. She has 
                    been the leader of PolyChord Ltd's initiative to join data science and biotechnology. Dr.Formanek has over 7 years of 
                    experience in data analysis in biology, physics, and chemistry. 
                </p>
            </div>
        </div>
        <div class="employee">
            ...
            <div class="employee__info-container">
                ...
                <p class="employee__title">Data Scientist</p>
                <p class="employee__text">
                    Dr.Paolo Mason specialises as a developer of models for risk quantification using sparse or incomplete data. 
                    He is heading activities involved with predictive maintenance. During his time with EDF Energy, an operator of UK 
                    nuclear power stations, Dr.Mason used Bayesian data science to create software to predict inspection regimes that 
                    EDF Energy employs today.
                </p>
            </div>
        </div>
        <div class="employee">
            ...
            <div class="employee__info-container">
                ...
                <p class="employee__title">Data Scientist</p>
                <p class="employee__text">
                    Dr.McAloone has been heading PolyChord Ltd's efforts toward ground-breaking technology to optimise sensor placement. 
                    He has worked directly with the UK Ministry of Defence to create a telecommunications application of said software. 
                    Dr.McAloone completed his studies working directly with PolyChord technology and therefore effortlessly entered the company.
                </p>
            </div>
        </div>
        <div class="employee">
            ...
            <div class="employee__info-container">
                ...
                <p class="employee__title">Data Scientist</p>
                <p class="employee__text">
                    Dr.Stenczel is crucial to the implementation and performance of PolyChord's software. He assists in the functionality 
                    of the core code developed at PolyChord Ltd. His background is mainly in Machine-Learning modelling and research-software 
                    engineering.
                </p>
            </div>
        </div>
